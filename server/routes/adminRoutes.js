...
adminRoutes.post("/api/v2/auth/admin/signup", signupValidation, adminSignupValidation, admin.createNewAdmins);
adminRoutes.post("/api/v2/auth/admin/login", adminLoginValidation, admin.loginAdmin);
adminRoutes.post("/api/v2/auth/admin/logout", admin.logoutAdmin);
